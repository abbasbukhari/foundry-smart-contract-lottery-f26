...
// ============================================================
// This file contains deployment interaction scripts for
// creating VRF subscriptions, funding them, and adding
// consumers on live networks.
//
// It is NOT needed for understanding Raffle.sol or writing
// tests. It is commented out so it doesn't distract you.
// Uncomment when you are ready to deploy to a real network.
// ============================================================
...
contract FundSubscription is CodeConstants, Script {
    ...
    function fundSubscription(
        ...
        if (block.chainid == LOCAL_CHAIN_ID) {
            ...
            // Requires LinkToken — come back to this for live network deployment
